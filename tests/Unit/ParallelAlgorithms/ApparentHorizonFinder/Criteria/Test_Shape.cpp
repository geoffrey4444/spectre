...
struct Metavariables {
  ...
  using const_global_cache_tags = tmpl::list<ah::Tags::MaxResolutionAndOutputL>;
...
void test_shape() {
  ...
  Parallel::GlobalCache<Metavariables<Frame::Inertial>> cache{
      tuples::TaggedTuple<ah::Tags::MaxResolutionAndOutputL>{max_resolution_l}};
  ...
  Parallel::GlobalCache<Metavariables<Frame::Inertial>> high_max_cache{
      tuples::TaggedTuple<ah::Tags::MaxResolutionAndOutputL>{mid_l * 4}};
  ...
  Parallel::GlobalCache<Metavariables<Frame::Inertial>> mid_shape_cache{
      tuples::TaggedTuple<ah::Tags::MaxResolutionAndOutputL>{mid_l}};
  test_criterion_evaluation<Frame::Inertial>(
  ...
  CHECK_THROWS_WITH(
      ...
      Catch::Matchers::ContainsSubstring(
          "If MinResolutionL == MaxResolutionAndOutputL"));
#endif
