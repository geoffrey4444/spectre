...
#include "src/DataStructures/Tensor/EagerMath/DivideBy.hpp"
...
void test_upwind_flux_random() noexcept {
  ...
  auto unit_normal_one_form_ext = minus_unit_normal_one_form_int;
  for (size_t i = 0; i < spatial_dim; ++i) {
    unit_normal_one_form_ext.get(i) /= one_form_magnitude_ext;
  }
