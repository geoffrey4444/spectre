  ...
  struct factory_creation
    ...
    using factory_classes = tmpl::map<
        tmpl::pair<PhaseChange,
                   tmpl::list<gh::bbh::phase_control::WriteVolumeDataAndExit>>>;
  };
};
}  // namespace

SPECTRE_TEST_CASE(
    "Unit.GeneralizedHarmonic.BbhWriteVolumeDataAndExitPhaseChange",
    "[Unit][Evolution]") {
  ...
  gh::bbh::phase_control::WriteVolumeDataAndExit phase_change{};
  using PhaseChangeDecisionData = tuples::TaggedTuple<
      gh::bbh::phase_control::Tags::WriteVolumeDataRequested,
