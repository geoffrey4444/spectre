...
struct MockReadVolumeData {
  ...
  static void apply(
      ...
      tuples::tagged_tuple_from_typelist<db::wrap_tags_in<
          importers::Tags::Selected, GeneralizedHarmonic::all_numeric_vars>>
          selected_fields) {
    const auto selected_vars =
        get<Tags::NumericInitialDataVariables<TestOptionGroup>>(cache);
    if (selected_vars == NumericInitialDataVariables::GeneralizedHarmonic) {
      ...
      CHECK(get<importers::Tags::Selected<Tags::Phi<3, Frame::Inertial>>>(
          selected_fields));
    } else if (selected_vars == NumericInitialDataVariables::Adm) {
      CHECK(get<importers::Tags::Selected<
...
struct MockVolumeDataReader {
  ...
  using replace_these_simple_actions =
      tmpl::list<importers::Actions::ReadAllVolumeDataAndDistribute<
          TestOptionGroup, GeneralizedHarmonic::all_numeric_vars,
...
void test_numeric_initial_data(
  ...
  auto& inbox = ActionTesting::get_inbox_tag<
      element_array,
      importers::Tags::VolumeData<TestOptionGroup,
                                  GeneralizedHarmonic::all_numeric_vars>,
...
SPECTRE_TEST_CASE("Unit.Evolution.Systems.Gh.NumericInitialData",
  ...
  test_numeric_initial_data(
      GeneralizedHarmonic::NumericInitialDataVariables::GeneralizedHarmonic);
  test_numeric_initial_data(
      GeneralizedHarmonic::NumericInitialDataVariables::Adm);
}
