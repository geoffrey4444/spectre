...
void test_is_equal() {
  ...
  const auto a = make_filter<Dim>(8, true, blocks, false, false, 2, std::nullopt);
  const auto b = make_filter<Dim>(8, true, blocks, false, false, 2, std::nullopt);
  const auto c = make_filter<Dim>(16, true, blocks, false, false, 2, std::nullopt);
