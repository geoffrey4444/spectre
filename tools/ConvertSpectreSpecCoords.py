...
def rename_variables(legend_line):
    ...
    legend_line = legend_line.replace('kappax', 'Phi_x')
    legend_line = legend_line.replace('kappay', 'Phi_y')
    legend_line = legend_line.replace('kappaz', 'Phi_z')
    legend_line = legend_line.replace('GradH', 'SpacetimeDerivGaugeH_')
    legend_line = legend_line.replace(' H', ' GaugeH_')
...
def get_spectre_points_per_block(spectre_file):
    ...
    components = ['InertialCoordinates_x', \
