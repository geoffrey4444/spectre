...
#include "PointwiseFunctions/AnalyticSolutions/EinsteinSolutions/KerrSchild.hpp"  // IWYU pragma: keep
...
struct EvolutionMetavars {
  ...
  using analytic_solution_tag =
      OptionTags::AnalyticSolution<EinsteinSolutions::KerrSchild>;
  using normal_dot_numerical_flux = OptionTags::NumericalFluxParams<
      GeneralizedHarmonic::ComputeNormalDotFluxes<Dim>>;
  ...
  static constexpr OptionString help{
      "Evolve a Kerr-Schild black hole with periodic boundary conditions.\n\n"
      "The analytic solution is: KerrSchild\n"
      "The numerical flux is:    ComputeNormalDotFluxes\n"};
