...
/*!
 * \brief Returns the generalized-harmonic 3-index constraint.
 *
 * \details Returns the generalized-harmonic 3-index constraint,
...
/*!
 * \brief Passes by reference the generalized-harmonic 3-index constraint.
 *
 * \details Passes by reference the generalized-harmonic 3-index constraint,
 * \f$C_{iab} = \partial_i\psi_{ab} - \Phi_{iab},\f$ which is
 * given by Eq. (26) of http://arXiv.org/abs/gr-qc/0512093v3
 */
template <size_t SpatialDim, typename Frame, typename DataType>
