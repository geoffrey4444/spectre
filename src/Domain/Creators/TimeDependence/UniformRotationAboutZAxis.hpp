...
class UniformRotationAboutZAxis final : public TimeDependence<MeshDim> {
 ...
 public:
  ...
  using options = tmpl::list<InitialTime, InitialAngularVelocity,
                             InitialAngularAcceleration>;

  static constexpr Options::String help = {
      "A spatially uniform rotation about the z axis initialized with an "
      "initial angular velocity and constant angular acceleration."};
  ...
  UniformRotationAboutZAxis(double initial_time,
