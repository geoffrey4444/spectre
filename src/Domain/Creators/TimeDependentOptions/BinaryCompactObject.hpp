...
struct TimeDependentMapOptions {
 ...
 public:
  ...
  using ExpansionMapOptions =
      domain::creators::time_dependent_options::ExpansionMap<false>;
  ...
  using RotationMapOptions =
      domain::creators::time_dependent_options::RotationMap<false>;
  ...
  using TranslationMapOptions =
      domain::creators::time_dependent_options::TranslationMap<3>;
  ...
  using ShapeMapOptions =
      domain::creators::time_dependent_options::ShapeMap<not IsCylindrical,
                                                         Object>;
  template <domain::ObjectLabel Object>
