...
struct ObserveSurfaceData
  ...
  static void apply(const db::DataBox<DbTags>& box,
    ...
    // When option MaxResolutionAndOutputL is present in the global cache,
    // check that the Strahlkorper resolution does not exceed it.
    // MaxResolutionAndOutputL sets a maximum resolution for
    ...
    if constexpr (Parallel::is_in_global_cache<
                      Metavariables, ah::Tags::MaxResolutionAndOutputL>) {
